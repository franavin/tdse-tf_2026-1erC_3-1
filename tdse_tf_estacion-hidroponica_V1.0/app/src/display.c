...
static void displayPinWrite( uint8_t pinName, int value )
{
    switch( display.connection ) {
        ...
        case DISPLAY_CONNECTION_GPIO_4BITS:
            switch( pinName ) {
            	case DISPLAY_PIN_D4: HAL_GPIO_WritePin(LCD_D4_PORT, D4_Pin, value);   break;
				case DISPLAY_PIN_D5: HAL_GPIO_WritePin(LCD_D5_PORT, D5_Pin, value);   break;
				case DISPLAY_PIN_D6: HAL_GPIO_WritePin(LCD_D6_PORT, D6_Pin, value);   break;
				case DISPLAY_PIN_D7: HAL_GPIO_WritePin(LCD_D7_PORT, D7_Pin, value);   break;
				case DISPLAY_PIN_RS: HAL_GPIO_WritePin(LCD_RS_PORT, D8_Pin, value);   break;
				case DISPLAY_PIN_EN: HAL_GPIO_WritePin(LCD_EN_PORT, D9_Pin, value);   break;
                case DISPLAY_PIN_RW: break;
                default: break;
            }
            break;
